...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/friendly-styles-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15004&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/friendly-styles-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `friendly-styles` can be installed with:

```
conda install friendly-styles
```

It is possible to list all of the versions of `friendly-styles` available on your platform with:
